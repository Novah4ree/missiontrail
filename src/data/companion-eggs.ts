...
export interface EggTypeDefinition {
  id: EggElement;
  element: EggElement;
  rarity: EggRarity;
...
/**
 * Canonical elemental egg artwork and rarity mapping.
 * Element/type IDs remain independent from rarity.
 */
export const EGG_TYPES: EggTypeDefinition[] = [
  {
    id: "water",
    element: "water",
    rarity: "common",
  ...
  },
  {
    ...
    element: "earth",
    rarity: "common",
    image: require("../../assets/eggs/common/earth/Duneheart Egg.png"),
  },
  {
    id: "nature",
    element: "nature",
  ...
  },
  {
    ...
    element: "frost",
    rarity: "rare",
    image: require("../../assets/eggs/rare/frost/Frosty Egg.png"),
  },
  {
    id: "storm",
    element: "storm",
    rarity: "epic",
    image: require("../../assets/eggs/epic/storm/Tempest Core Egg.png"),
  },
  {
    id: "toxic",
    element: "toxic",
  ...
  },
  {
    ...
    element: "crystal",
    rarity: "epic",
    image: require("../../assets/eggs/epic/crystal/Prismatic Egg.png"),
  },
  {
    id: "solar",
    element: "solar",
  ...
  },
  {
    ...
    element: "luna",
    rarity: "legendary",
    image: require("../../assets/eggs/legendary/lunar/Moonveil Egg.png"),
  },
  {
    id: "spirit",
    element: "spirit",
    rarity: "legendary",
    image: require("../../assets/eggs/legendary/spirit/Spectral Wyrm Egg.png"),
  },
  {
    id: "cosmic",
    element: "cosmic",
  ...
  },
  {
    ...
    element: "void",
    rarity: "mythic",
    image: require("../../assets/eggs/mythic/void/Void Requiem Egg.png"),
  },
  {
    id: "ancient",
    element: "ancient",
...
export const EGG_TYPES_BY_ELEMENT = Object.fromEntries(
  EGG_TYPES.map((eggType) => [eggType.element, eggType]),
) as Record<EggElement, EggTypeDefinition>;

export type EggTier = "Standard" | "Enhanced" | "Rare" | "Epic" | "Legendary";
...
const COMPANION_EGG_DEFINITIONS: Omit<CompanionEgg, "rarity">[] = [
  // ==================================================
  // WATER
  // ==================================================

  {
    ...
    image: EGG_TYPES_BY_ELEMENT.water.image,
    glowColor: "#45DFFF",
    rarityBoost: 1,
    hatchPool: [
      "bubble-slime",
...

  {
    ...
    hatchDistanceMiles: 1.5,
    image: EGG_TYPES_BY_ELEMENT.fire.image,
    glowColor: "#FF6B00",
    rarityBoost: 1,
    hatchPool: [
      "ember-pup",
...

  {
    ...
    element: "fire",
    tier: "Rare",
    description: "Molten veins pulse through this heavy volcanic egg.",
...

  {
    ...
    element: "fire",
    tier: "Epic",
    description: "Black volcanic glass conceals a furnace of unstable energy.",
...

  {
    ...
    element: "storm",
    tier: "Standard",
    description: "Lightning continuously circles the storm trapped within.",
    hatchDistanceMiles: 2,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#65E8FF",
    rarityBoost: 1,
...

  {
    ...
    element: "earth",
    tier: "Standard",
    description: "An impossibly dense egg formed from ancient stone.",
    hatchDistanceMiles: 1.75,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#C58A52",
    rarityBoost: 1,
...

  {
    ...
    element: "luna",
    tier: "Standard",
    description: "Silver lunar energy drifts beneath its shadowed shell.",
...

  {
    ...
    element: "luna",
    tier: "Epic",
    description: "A sleeping lunar presence seems to dream inside this egg.",
    hatchDistanceMiles: 4,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#B8A7FF",
    rarityBoost: 1.65,
...

  {
    ...
    element: "solar",
    tier: "Standard",
    description: "Solar energy burns steadily inside a forged golden shell.",
    hatchDistanceMiles: 2.5,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#FFD95A",
    rarityBoost: 1,
...

  {
    ...
    element: "solar",
    tier: "Epic",
    description: "Ancient solar symbols shift across this radiant shell.",
    hatchDistanceMiles: 4,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#FFBD2E",
    rarityBoost: 1.65,
...

  {
    ...
    element: "cosmic",
    tier: "Standard",
    description: "A tiny nebula appears to breathe inside this celestial egg.",
    hatchDistanceMiles: 3,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#7DEEFF",
    rarityBoost: 1,
...

  {
    ...
    element: "cosmic",
    tier: "Epic",
    description: "A newborn star burns quietly behind its cosmic shell.",
...

  {
    ...
    element: "spirit",
    tier: "Standard",
    description: "Ghostly light drifts in and out of this ethereal shell.",
    hatchDistanceMiles: 3,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#D6FFF6",
    rarityBoost: 1,
...

  {
    ...
    element: "spirit",
    tier: "Epic",
    description: "The shadow of a serpentine spirit circles within.",
    hatchDistanceMiles: 4.5,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#A5F3FC",
    rarityBoost: 1.65,
...

  {
    ...
    element: "tech",
    tier: "Standard",
    description: "Circuits flicker beneath the shell of this mechanical egg.",
    hatchDistanceMiles: 3.5,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#00F5FF",
    rarityBoost: 1,
...

  {
    ...
    element: "tech",
    tier: "Epic",
    description: "Unknown machinery resonates with every movement around it.",
    hatchDistanceMiles: 5,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#22D3EE",
    rarityBoost: 1.65,
...

  {
    ...
    element: "void",
    tier: "Epic",
    description: "Light bends toward the dark core hidden within this egg.",
    hatchDistanceMiles: 5,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#7C3AED",
    rarityBoost: 1.65,
...

  {
    ...
    element: "void",
    tier: "Legendary",
    description: "An ominous rhythm echoes from somewhere beyond the shell.",
...

  {
    ...
    element: "ancient",
    tier: "Rare",
    description: "An egg seemingly older than every mapped trail.",
    hatchDistanceMiles: 4,
    image: UNDISCOVERED_EGG_ART,
    glowColor: "#D6A84B",
    rarityBoost: 1.35,
...

  {
    ...
    element: "ancient",
    tier: "Epic",
    description: "Mechanical gears move inside a shell untouched by time.",
...
export const COMPANION_EGGS: CompanionEgg[] = COMPANION_EGG_DEFINITIONS.map(
  (egg) => {
    const eggType = EGG_TYPES_BY_ELEMENT[egg.element];
...
export function getEggsByTier(tier: EggTier) {
  return COMPANION_EGGS.filter((egg) => egg.tier === tier);
}

// Purpose: Returns eggs by elemental rarity.
export function getEggsByRarity(rarity: EggRarity) {
  return COMPANION_EGGS.filter((egg) => egg.rarity === rarity);
}
